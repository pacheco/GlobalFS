...
case $NAME in
    rep*)
        ...
        # ;;
        FULLCMD="export DB=$DB; java -Xmx2G -Xms1G -ea -cp $CLASSPATH $JVMOPT $GC -Djava.library.path=$LIBPATH ch.usi.paxosfs.replica.FSMain -n 3 -p $RING -i $ID -s $PORT -z $ZKHOST:2182"
