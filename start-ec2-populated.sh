...
#------------
xterm -e "ssh $DC1_ACC_0 sinergiafs/node-ec2.sh $CLI $NBLOCKS $BLOCKSIZE; sleep 1000" &
xterm -e "ssh $DC1_REP_0 sinergiafs/node-ec2.sh $CLI $NBLOCKS $BLOCKSIZE; sleep 1000" &
xterm -e "ssh $DC2_REP_0 sinergiafs/node-ec2.sh $CLI $NBLOCKS $BLOCKSIZE; sleep 1000" &
xterm -e "ssh $DC3_REP_0 sinergiafs/node-ec2.sh $CLI $NBLOCKS $BLOCKSIZE; sleep 1000" &

sleep 5

# start everything else
#------------
xterm -e "ssh $DC2_ACC_0 sinergiafs/node-ec2.sh $CLI $NBLOCKS $BLOCKSIZE; sleep 1000" &

xterm -e "ssh $DC1_REP_1 sinergiafs/node-ec2.sh $CLI $NBLOCKS $BLOCKSIZE; sleep 1000" &
xterm -e "ssh $DC1_REP_2 sinergiafs/node-ec2.sh $CLI $NBLOCKS $BLOCKSIZE; sleep 1000" &

xterm -e "ssh $DC2_REP_1 sinergiafs/node-ec2.sh $CLI $NBLOCKS $BLOCKSIZE; sleep 1000" &
xterm -e "ssh $DC2_REP_2 sinergiafs/node-ec2.sh $CLI $NBLOCKS $BLOCKSIZE; sleep 1000" &

xterm -e "ssh $DC3_REP_1 sinergiafs/node-ec2.sh $CLI $NBLOCKS $BLOCKSIZE; sleep 1000" &
xterm -e "ssh $DC3_REP_2 sinergiafs/node-ec2.sh $CLI $NBLOCKS $BLOCKSIZE; sleep 1000" &
